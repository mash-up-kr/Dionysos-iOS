...
open class SmoothPickerView: UIView {
    ...
    private func commInit () {
        ...
        sliderCollectionView?.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 0).isActive = true
        sliderCollectionView?.trailingAnchor.constraint(equalTo: trailingAnchor, constant: 0).isActive = true
        sliderCollectionView?.bottomAnchor.constraint(equalTo: bottomAnchor, constant: 0).isActive = true
        sliderCollectionView?.topAnchor.constraint(equalTo: topAnchor, constant: 0).isActive = true
        sliderCollectionView?.addObserver(self, forKeyPath: "contentSize", options: .old, context: nil)
        sliderCollectionView?.register(SmoothPickerCollectionViewCell.self, forCellWithReuseIdentifier: cellIdentifier)
        sliderCollectionView?.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0)
